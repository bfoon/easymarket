...
# Warehouse Receiving URLs
    ...
    # Crossroad Logistics Dashboard (Easy Move Orders)
    ...
    path('crossroad/order/<uuid:order_id>/complete-vetting/', views.mark_vetting_complete,
         name='mark_vetting_complete'),
